...
This directory establishes the architecture-first specifications of the Chrysalis Engine Layer, before implementation code is written, to prevent architectural drift.
